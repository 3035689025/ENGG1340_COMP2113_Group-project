...
1. Gameplay file for programming the main game-play and including the dialogues that provides the introduction and different special rules each week.

2. Event file for programming some special event that may happen on a particular gameweek. Those event functions will be called on particular game-weeks.
